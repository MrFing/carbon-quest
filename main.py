...
ECO_COSTS = {
    ...
    "Reduce Meat Diet": 3000,
    "Local Food Market": 2500,
    "Ban Single Use Plastic": 4000,
    "Green Shopping Policy": 3500,
    "Public Awareness Campaign": 2800,
    "Community Garden": 3500,
    "Public Library": 2800,
    "Youth Sports Centre": 4000,
    "Community Solar Project": 5000,
    "Local Farmers Market": 2500,
    "Plant Community Garden": 4500,
    "Build Public Library": 6000,
    "Build Youth Sports Centre": 5500,
    "Community Solar Project": 8000,
    "Support Farmers Market": 3500,
...
QUICK_COSTS = {
    ...
    "Urban Farm Network": 900,
    "Reduce Meat Diet": 800,
    "Local Food Market": 500,
    "Ban Single Use Plastic": 400,
    "Green Shopping Policy": 500,
    "Public Awareness Campaign": 800,
    "Pave Community Land": 400,
    "Cut Library Funding": 300,
    "Build Parking Lot": 500,
    "Use Diesel Generator": 600,
    "Open Fast Food Chain": 350,
}
...
class CityRenderer:
    def __init__(self):
        ...
        self.zone_visuals["Consumption"] = {"score": 0.0, "target": 0.0}
        self.zone_centers["Consumption"] = (450, self.area.y + base_y - 60)
        self.zone_visuals["Community"] = {"score": 0.0, "target": 0.0}
        self.zone_centers["Community"] = (300, self.area.y + base_y - 60)
...
class CardSystem:
    ...
    def _build_cards(self):
        ...
        return [
            ...
            make_card("Consumption", "City Food Habits",
                      "Reduce Meat Diet", -5, 4, "Build Shopping Mall", 9, -6),
            make_card("Consumption", "Plastic Crisis",
                      "Ban Single Use Plastic", -6, 5, "Build Shopping Mall", 9, -6),
            make_card("Consumption", "Local Market Vote",
                      "Local Food Market", -4, 4, "Build Shopping Mall", 9, -6),
            make_card("Consumption", "Shopping District Plan",
                      "Green Shopping Policy", -5, 3, "Build Shopping Mall", 9, -6),
            make_card("Consumption", "Awareness Drive",
                      "Public Awareness Campaign", -3, 5, "Build Shopping Mall", 9, -6),
            make_card("Community", "Neighbourhood Renewal",
                      "Plant Community Garden", -5, 6, "Pave Community Land", 8, -5),
            make_card("Community", "Education Budget Vote",
                      "Build Public Library", -4, 7, "Cut Library Funding", 5, -6),
            make_card("Community", "Youth Development Plan",
                      "Build Youth Sports Centre", -3, 5, "Build Parking Lot", 6, -4),
            make_card("Community", "Local Energy Decision",
                      "Community Solar Project", -7, 5, "Use Diesel Generator", 10, -5),
            make_card("Community", "High Street Revival",
                      "Support Farmers Market", -4, 6, "Open Fast Food Chain", 7, -4),
        ]
...
class Game:
    ...
    def reset_game(self):
        ...
        self.zone_scores["Consumption"] = 0
        self.zone_scores["Community"] = 0
...
# To build: pyinstaller --onefile --noconsole main.py
>>>>>>> df5fbbda28601550f0ab996858f9c478ad122761
